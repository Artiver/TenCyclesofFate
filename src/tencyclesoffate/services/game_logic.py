...
# --- Prompt Loading ---
GAME_MASTER_SYSTEM_PROMPT = load_prompt("game_master.txt")
START_GAME_PROMPT = load_prompt("start_game_prompt.txt")
START_TRIAL_PROMPT = load_prompt("start_trial_prompt.txt")
